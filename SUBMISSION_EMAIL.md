...
frame-exact while a perception model is fooled by occlusion — and I use that same code-truth as an
automated critic for hallucinated dynamics in world-model rollouts (à la DIAMOND). A small PPO
